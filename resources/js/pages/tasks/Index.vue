...
<template>
    ...
    <div class="space-y-6 p-6">
        <div class="flex items-center justify-between">
            ...
            <Button><Plus class="mr-2 h-4 w-4" />New Task</Button>
        </div>
        ...
        <div class="space-y-2">
            <div v-for="todo in allTodos" :key="todo.id" class="flex items-center gap-4 rounded-lg border p-4 hover:bg-muted/50 transition-colors">
                <input type="checkbox" :checked="todo.status === 'completed'" class="h-4 w-4 rounded border-gray-300" @change="toggleComplete(todo)" />
                ...
                <Button variant="ghost" size="sm" @click="deleteTodo(todo)"><Trash2 class="h-4 w-4" /></Button>
            </div>
        </div>
