...
import { CheckCircle, Clock, AlertTriangle, TrendingUp, List } from '@lucide/vue';
...
const stats = computed(() => {
    ...
    const overdue = props.todos.filter(t => t.due_date && t.due_date < today && t.status !== 'completed').length;
...
<template>
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <Card>
            ...
            <CardContent><div class="text-2xl font-bold">{{ stats.pending }}</div></CardContent>
        </Card>
        <Card>
            <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent><div class="text-2xl font-bold">{{ stats.inProgress }}</div></CardContent>
        </Card>
        <Card>
            <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent><div class="text-2xl font-bold">{{ stats.completed }}</div></CardContent>
        </Card>
        <Card>
            <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent><div class="text-2xl font-bold">{{ stats.overdue }}</div></CardContent>
        </Card>
    </div>
</template>
