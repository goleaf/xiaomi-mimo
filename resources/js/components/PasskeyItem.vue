            ...
            <div class="space-y-1">
                <div class="flex items-center gap-2.5">
                    ...
                    <span
                        ...
                        class="inline-flex items-center gap-1 rounded-lg border border-border/80 bg-muted/60 px-2 py-0.5 text-[11px] font-medium tracking-wide text-muted-foreground uppercase"
                    >
